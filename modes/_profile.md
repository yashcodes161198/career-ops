...
Use only facts found in `cv.md`, `article-digest.md`, and confirmed candidate
answers. Do not assume a technology, achievement, leadership scope, or metric.

| If the role is... | Emphasize verified evidence about... | Proof point sources |
|-------------------|-------------------------------------|---------------------|
...
Use the candidate's confirmed exit story from `config/profile.yml`. If it has
not been supplied, ask instead of drafting one.

## Your Cross-cutting Advantage

Derive this from evidence in `cv.md`. Do not use a generic positioning statement
until the candidate approves it.

## Your Portfolio / Demo

Use only portfolio, GitHub, project, or demo links present in
`config/profile.yml` or `cv.md`.

## Your Comp Targets

Use the INR and global-remote targets from `config/profile.yml`. Treat salary
figures in job listings as unverified until their period and currency are clear.

## Your Location Policy

- Prefer remote roles that explicitly accept candidates in India, worldwide, or APAC.
- Accept Bengaluru, Hyderabad, Pune, NCR, Chennai, and Mumbai.
- Flag remote roles whose description limits hiring to the US, UK, EU, or another country.
- Never infer work authorization or willingness to relocate.
