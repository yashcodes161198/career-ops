# Evaluation: Airbnb — Senior Software Engineer(AI/ML), Trust

**Date:** 2026-09-07
**URL:** https://careers.airbnb.com/positions/8154477?gh_jid=8154477
**Via:** —
**Archetype:** Senior Backend Engineer
**Score:** 4.8/5
**Legitimacy:** Proceed with Caution
**Work Auth:** ➖ Not needed
**PDF:** not generated — run /career-ops pdf airbnb to create on demand
...
```yaml
company: "Airbnb"
role: "Senior Software Engineer(AI/ML), Trust"
score: 4.8
...
| TL;DR | Strong fit for Yash's backend/full-stack profile at Airbnb. |
...
Senior Software Engineer(AI/ML), Trust at Airbnb. Location: India.
