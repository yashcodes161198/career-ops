# Evaluation: Coinbase — Staff Software Engineer, Security Platform

**Date:** 2026-09-07
**URL:** https://www.coinbase.com/careers/positions/8167571?gh_jid=8167571
**Via:** —
**Archetype:** Senior Platform Engineer
**Score:** 4.8/5
**Legitimacy:** Proceed with Caution
**Work Auth:** ➖ Not needed
**PDF:** not generated — run /career-ops pdf coinbase to create on demand
...
```yaml
company: "Coinbase"
role: "Staff Software Engineer, Security Platform"
score: 4.8
...
| TL;DR | Strong fit for Yash's backend/full-stack profile at Coinbase. |
...
Staff Software Engineer, Security Platform at Coinbase. Location: India.
